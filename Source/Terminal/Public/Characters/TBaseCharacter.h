...
#include "Components/TFileData.h"
...
struct TERMINAL_API FMovementFlipbooks
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class TERMINAL_API ATBaseCharacter : public APaperCharacter
{
	GENERATED_BODY()
...
protected:
	...
	* Use for footstep sound or particle effects in Blueprints.
	...
	TObjectPtr<UTFileData> FileDataComponent;
	...
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Config")
	//TArray<AOST_Interactable*> InteractableActors;
